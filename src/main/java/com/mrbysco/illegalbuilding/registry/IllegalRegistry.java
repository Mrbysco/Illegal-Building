...
public class IllegalRegistry {
	...
	public static final DeferredBlock<OffsetBlock> OFFSET_STONE = BLOCKS.register("offset_stone", () -> new OffsetBlock(Block.Properties.copy(Blocks.STONE).requiresCorrectToolForDrops().strength(1.5F, 6.0F).noOcclusion().isRedstoneConductor(OffsetBlock::isntSolid)));

	public static final DeferredBlock<Block> IMPOSSIBLE_OAK_LOG = BLOCKS.register("impossible_oak_log", () -> new Block(Block.Properties.copy(Blocks.OAK_PLANKS).strength(2.0F, 3.0F)));
	public static final DeferredBlock<Block> IMPOSSIBLE_SPRUCE_LOG = BLOCKS.register("impossible_spruce_log", () -> new Block(Block.Properties.copy(Blocks.SPRUCE_PLANKS).strength(2.0F, 3.0F)));
	public static final DeferredBlock<Block> IMPOSSIBLE_BIRCH_LOG = BLOCKS.register("impossible_birch_log", () -> new Block(Block.Properties.copy(Blocks.BIRCH_PLANKS).strength(2.0F, 3.0F)));
	public static final DeferredBlock<Block> IMPOSSIBLE_JUNGLE_LOG = BLOCKS.register("impossible_jungle_log", () -> new Block(Block.Properties.copy(Blocks.JUNGLE_PLANKS).strength(2.0F, 3.0F)));
	public static final DeferredBlock<Block> IMPOSSIBLE_ACACIA_LOG = BLOCKS.register("impossible_acacia_log", () -> new Block(Block.Properties.copy(Blocks.ACACIA_PLANKS).strength(2.0F, 3.0F)));
	public static final DeferredBlock<Block> IMPOSSIBLE_DARK_OAK_LOG = BLOCKS.register("impossible_dark_oak_log", () -> new Block(Block.Properties.copy(Blocks.DARK_OAK_PLANKS).strength(2.0F, 3.0F)));

	public static final DeferredBlock<ImpossibleSandBlock> IMPOSSIBLE_SAND = BLOCKS.register("impossible_sand", () -> new ImpossibleSandBlock(14406560, Block.Properties.copy(Blocks.SAND).strength(0.5F).sound(SoundType.SAND)));
	public static final DeferredBlock<ImpossibleSandBlock> IMPOSSIBLE_RED_SAND = BLOCKS.register("impossible_red_sand", () -> new ImpossibleSandBlock(11098145, Block.Properties.copy(Blocks.RED_SAND).strength(0.5F).sound(SoundType.SAND)));

	public static final DeferredBlock<ImpossibleSugarCaneBlock> IMPOSSIBLE_SUGAR_CANE = BLOCKS.register("impossible_sugar_cane", () -> new ImpossibleSugarCaneBlock(Block.Properties.copy(Blocks.SUGAR_CANE).noCollission().randomTicks().instabreak().sound(SoundType.GRASS)));
	public static final DeferredBlock<ImpossibleCactusBlock> IMPOSSIBLE_CACTUS = BLOCKS.register("impossible_cactus", () -> new ImpossibleCactusBlock(Block.Properties.copy(Blocks.CACTUS).randomTicks().strength(0.4F).sound(SoundType.WOOL)));
